...
const buildOutputDir = process.env.VSCODE_BUILD_OUTPUT_DIR || path.dirname(repoPath);
const buildPath = (/** @type {string} */ arch) => path.join(buildOutputDir, `VSCode-win32-${arch}`);
