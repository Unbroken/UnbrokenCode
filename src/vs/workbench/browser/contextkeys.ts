...
import { IsMacContext, IsLinuxContext, IsWindowsContext, IsWebContext, IsMacNativeContext, IsDevelopmentContext, IsIOSContext, ProductQualityContext, IsMobileContext, IsUnbrokenContext } from '../../platform/contextkey/common/contextkeys.js';
...
export class WorkbenchContextKeysHandler extends Disposable {
	...
	constructor(
		...
		// Product
		IsUnbrokenContext.bindTo(this.contextKeyService);
