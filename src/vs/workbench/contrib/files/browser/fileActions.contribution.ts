...
// Leaf navigation commands (no default keybindings)
CommandsRegistry.registerCommand({
	id: 'filesExplorer.focusNextLeaf',
	handler: focusNextLeafHandler,
	metadata: {
		description: nls.localize('focusNextLeaf', "Focus Next File (Leaf) in Explorer"),
		args: []
	}
});

CommandsRegistry.registerCommand({
	id: 'filesExplorer.focusPreviousLeaf',
	handler: focusPreviousLeafHandler,
	metadata: {
		description: nls.localize('focusPreviousLeaf', "Focus Previous File (Leaf) in Explorer"),
		args: []
	}
});

CommandsRegistry.registerCommand({
	id: 'filesExplorer.focusNextLeafExpand',
	handler: focusNextLeafExpandHandler,
	metadata: {
		description: nls.localize('focusNextLeafExpand', "Focus Next File (Leaf) in Explorer with Auto-Expand"),
		args: []
	}
});

CommandsRegistry.registerCommand({
	id: 'filesExplorer.focusPreviousLeafExpand',
	handler: focusPreviousLeafExpandHandler,
	metadata: {
		description: nls.localize('focusPreviousLeafExpand', "Focus Previous File (Leaf) in Explorer with Auto-Expand"),
		args: []
	}
});
